    ...
    <>
      <section id="technologies-section">
        ...
        <div className="technologies-container">
          <div className="technologies-container__html tech-card">
            <h4>Html5</h4>
            <svg
            ...
            <p>
              The backbone of every webpage — defines the structure and content
              using semantic elements.
            </p>
          </div>
          <div className="technologies-container__css tech-card">
            <h4>Css3</h4>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            ...
            <p>
              Styles the structure of web pages — controls layout, colors,
              animations, and overall visual vibe.
            </p>
          </div>
          <div className="technologies-container__js tech-card">
            <h4>Javascript</h4>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
            ...
            <p>
              The logic behind the scenes — adds interactivity and dynamic
              behavior to web pages.
            </p>
          </div>
          <div className="technologies-container__react tech-card">
            <h4>React</h4>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            ...
            <p>
              A powerful JavaScript library for building fast, dynamic user
              interfaces using reusable components.
            </p>
          </div>
          <div className="technologies-container__tailwind tech-card">
            <h4>Tailwind</h4>
            <svg
              className="tech-icon"
              aria-hidden="true"
            ...
            <p>
              A utility-first CSS framework that lets you build custom designs
              without writing traditional CSS.
            </p>
          </div>
          <div className="technologies-container__node-js tech-card">
            <h4>Node js</h4>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 512"
            ...
            <p>
              A fast, scalable runtime for building backend services using
              JavaScript — ideal for APIs, servers, and real-time apps.
            </p>
          </div>
          <div className="technologies-container__python tech-card">
            <h4>Python</h4>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
            ...
            <p>
              A versatile programming language used for everything from web
              development (like Django) to automation, AI, and more.
            </p>
          </div>
          <div className="technologies-container__java tech-card">
            <h4>Java</h4>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 384 512"
            ...
            <p>
              A powerful, object-oriented language used to build scalable
              backend systems, often with frameworks like Spring Boot.
            </p>
          </div>
        </div>
      </section>
